...
const navItems = ["Home", "About Us", "Service", "Portfolio", "Contact"];
...
//         <section
//             ref={heroRef}
//             className="min-h-screen bg-[#111111] px-4 py-5 text-white sm:px-6 lg:px-8"
//         >
//             {/* Top Navigation */}
//             <header className="grid grid-cols-3 items-start">
//                 {/* Logo */}
...
//             {/* Bottom Content */}
//             <div className="mt-14 grid grid-cols-12 items-start gap-8 lg:mt-20">
//                 {/* Social Links */}
//                 <div
//                     ref={socialRef}
//                     className="col-span-12 self-end lg:col-span-5"
//                 >
//                     <div className="flex max-w-[330px] flex-wrap gap-x-6 gap-y-3 text-[18px]">
//                         {socialLinks.map((social) => (
//                             <a
...
//                     <p
//                         ref={growthRef}
//                         className="max-w-[150px] text-[18px] leading-[1.3]"
//                     >
//                         From 1994–2025
//                         <br />
//                         we're growing
...
//                             <a
//                                 href="#"
//                                 className="rounded-full border border-white px-8 py-3 text-[17px] font-medium transition-colors duration-200 hover:bg-white hover:text-black"
//                             >
//                                 Get Started
//                             </a>
...
//                                 className="ml-2 flex h-[47px] w-[47px] items-center justify-center rounded-full border border-white text-xl transition-colors duration-200 hover:bg-white hover:text-black"
//                             >
//                                 ↗
//                             </a>
//                         </div>
